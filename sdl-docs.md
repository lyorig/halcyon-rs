...
Your task is to add SDL's documentation to halcyon-rs wrappers in a manner that "maps" it to Rust terms while preserving *what the SDL function does*.
...
- If a docblock references another SDL function, change it to the halcyon-rs equivalent.
